//😎️C Program to implement Fractional Knapsack

    #include <stdio.h>
    int n = 5; // The number of objects
    int c[5] = {12, 1, 2, 1, 4}; // c[i] is the *COST* of the ith object; i.e. what we pay to take the object
    int v[5] = {4, 2, 2, 1, 10}; // v[i] is the *VALUE* of the ith object; i.e. what we get for taking the object
